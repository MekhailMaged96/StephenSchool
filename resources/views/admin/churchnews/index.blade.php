...
<section class="all-users">
    ...
    <div class="row">
        <a href="{{route('news.church.create')}}" class="btn btn-primary ml-auto mr-3"><i class='fas fa-plus'></i> انشاء </a>
    </div>
            ...
            <table class="table table-sm table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                        <a href="{{route('news.church.show',$new->id)}}">{{$new->title}}
                        </a>
                        </td>
                        <td dir="ltr">{{date("Y-m-d h:i A  ", strtotime($new->created_at))}} </td>
                        <td><a href="{{route('news.church.edit',$new->id)}}" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
...
var app = new Vue({
   ...
   getdata:function(id){
    ...
    deleteitem:function(){
        ...
        axios.delete('/admin/news/church/'+this.new).then(function (response) {
                 location.reload(); 
           });
