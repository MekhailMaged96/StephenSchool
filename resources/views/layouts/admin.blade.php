...
<div class="container-fluid " id="app">
    <div class="row d-flex d-md-block flex-nowrap wrapper">
        <div class="col-md-2 float-right col-1 pl-0 pr-0 collapse width " id="sidebar">
                ...
                <a href="#menu7" class="list-group-item d-inline-block collapsed" data-toggle="collapse" data-parent="#sidebar" aria-expanded="false"><span class="d-none d-md-inline">المدرسة</span>  <i class="fas fa-school"></i> </a>
                <div class="collapse" id="menu7">
                    <a href="{{route('school.settings.index')}}" class="list-group-item" data-parent="#menu7"> اعدادت المدرسة <i class="fas fa-cogs"></i></a>
                </div>
                ...
                @endisposts
                @if(Auth::guard('admin')->user()->role->id==4 || Auth::guard('admin')->user()->role->id==6 || Auth::guard('admin')->user()->role->id==1 || Auth::guard('admin')->user()->role->id==2)
                ...
                <a href="#menu10" class="list-group-item d-inline-block collapsed" data-toggle="collapse" data-parent="#sidebar" aria-expanded="false"><span class="d-none d-md-inline">الادمن</span> <i class="fas fa-user-cog"></i> </a>
                <div class="collapse" id="menu10"> 
	
                    <a href="{{route('admin.settings.index')}}" class="list-group-item" data-parent="#menu10">كل الادمن <i class="fas fa-users"></i></a>

                </div>
                @endissuper

                @isgrades
                <a href="#menu6" class="list-group-item d-inline-block collapsed" data-toggle="collapse" data-parent="#sidebar" aria-expanded="false"><span class="d-none d-md-inline">الدرجات</span> <i class="fas fa-award"></i> </a>
                <div class="collapse" id="menu6"> 
                      
                    <a href="{{route('grade.allclasses')}}" class="list-group-item" data-parent="#menu6">النتائج <i class="fas fa-clipboard-list"></i></a> 
                </div>
                @endisgrades
